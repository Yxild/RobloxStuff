...
function library:CreateWindow(name, version, icon)
    ...
    Icon.ImageColor3 = Color3.fromRGB(255, 135, 135)
    ...
    TitleUnderline.BackgroundColor3 = Color3.fromRGB(255, 135, 135)
    ...
    Close.MouseButton1Click:Connect(function()
        TS:Create(Window, TweenInfo.new(0.5), {Size = UDim2.new(0, 600, 0, 0)})
            :Play()
        repeat wait() until Window.Size == UDim2.new(0, 600, 0, 0)
        wait(0.1)
        TS:Create(Window, TweenInfo.new(0.5), {Size = UDim2.new(0, 0, 0, 0)})
            :Play()
        repeat wait() until Window.Size == UDim2.new(0, 0, 0, 0)
        MyGui:Remove()
    end)
    ...
    Minimize.MouseButton1Click:Connect(function()
        if not MinimizeGui then
            ...
            if Window.Size == UDim2.new(0, 600, 0, 400) then
                TS:Create(Window, TweenInfo.new(0.25),
                          {Size = UDim2.new(0, 600, 0, 32)}):Play()
    ...
    repeat wait() until Window.Size == UDim2.new(0, 600, 0, 0)
    wait(0.1)
    TS:Create(Window, TweenInfo.new(0.5), {Size = UDim2.new(0, 600, 0, 400)})
        :Play()
    ...
    function tabs:CreateTab(name)
        ...
        function mytabbuttons:CreateFrame(name)
                    ...
                    if v:IsA("Frame") then
                        if search ~= "" then
                            ...
                            elseif v.Name == "TextBox" then
                                local item = string.lower(
                                                 v.Container.TextInput.Text)
                                if string.find(item, search) then
                                    v.Visible = true
                                else
                                    v.Visible = false
                            ...
                            elseif v.Name == "Keybind" then
                                local item =
                                    string.lower(v.Container.Title.Text)
                                if string.find(item, search) then
                                    v.Visible = true
                                else
                                    v.Visible = false
            ...
            PageButton.MouseButton1Down:Connect(function()
                ...
                TS:Create(Indicator, TweenInfo.new(0.5),
                ...
                for i, v in next, Tabs:GetChildren() do
                    if v:IsA("TextButton") and v.Name == "PageButton" then
                        TS:Create(v, TweenInfo.new(0.5),
                                  {TextTransparency = 0.5}):Play()
                    end
                end
                wait()
                TS:Create(PageButton, TweenInfo.new(0.5), {TextTransparency = 0})
                    :Play()
                Indicator.Parent = PageButton

                for i, v in pairs(Window:GetChildren()) do
                    if v:IsA("ScrollingFrame") and v.Name ~= "Tabs" and v.Name ~=
                        "TitleBar" and v.Name ~= "UICorner" then
                        v.Visible = false
                    end
                end
            ...
            function pagebuttons:CreateButton(name, desc, callback)
                ...
                spawn(function()
                    local function QCZV_fake_script() -- Caller.Handler 
                        ...
                        Sample.Image =
                            "http://www.roblox.com/asset/?id=4560909609"
                        ...
                        btn.MouseButton1Click:Connect(function()
                            ...
                            c.Parent = btn
                            local x, y = (ms.X - c.AbsolutePosition.X),
                                         (ms.Y - c.AbsolutePosition.Y)
            ...
            function pagebuttons:CreateSlider(name, min, max, callback)
                ...
                function library4:SetValue(input)
                    local pos = UDim2.new(math.clamp(
                                              (input.Position.X -
                                                  SliderBar.AbsolutePosition.X) /
                                                  SliderBar.AbsoluteSize.X, 0, 1),
                                          0, 0, (SliderBar.AbsoluteSize.Y))
                    Slider_2:TweenSize(pos, Enum.EasingDirection.Out,
                                       Enum.EasingStyle.Quad, 0.2, true)
                    local value = math.floor(
                                      (((pos.X.Scale * max) / max) * (max - min) +
                                          min) * 100) / 100
                ...
                Sliderbutton.InputBegan:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseButton1 then
                        dragging = true
                        TS:Create(Fade, TweenInfo.new(.1),
                                  {BackgroundTransparency = 0.8}):Play()
                        TS:Create(Shadow_1, TweenInfo.new(.1),
                                  {ImageTransparency = 0.7}):Play()
                        TS:Create(Shadow_2, TweenInfo.new(.1),
                                  {ImageTransparency = 0.7}):Play()
                    end
                end)
            ...
            function pagebuttons:CreateBind(name, defaultkey, callback)
                ...
                game:GetService("UserInputService").InputBegan:Connect(function(
                    ...
                    if Key.UserInputType == Enum.UserInputType.Keyboard and
                        Key.KeyCode.Name == CurrentKey then
                        local btn = KButton
                        local sample = Sample
                        local c = sample:Clone()
                        c.Parent = btn
            ...
            function pagebuttons:CreateColorPicker(name, callback)
                ...
                ColourGradientFrame.BackgroundColor3 =
                    Color3.fromRGB(255, 255, 255)
                ColourGradientFrame.BorderSizePixel = 0
                ColourGradientFrame.Position =
                    UDim2.new(0.0170000009, 0, 0.699999988, 0)
                ...
                ColourGradient.Color = ColorSequence.new {
                ...
                ColourPreview.Position =
                    UDim2.new(-0.0155634917, 0, 0.651912689, 0)
                ColourPreview.Size =
                    UDim2.new(0.00590497162, 0, 0.0980872661, 0)
                ColourPreview.Visible = false

                DarknessGradientFrame.Name = "DarknessGradientFrame"
                DarknessGradientFrame.Parent = ColorPicker
                DarknessGradientFrame.BackgroundColor3 = Color3.fromRGB(255,
                                                                        255, 255)
                DarknessGradientFrame.BorderSizePixel = 0
                DarknessGradientFrame.Position =
                    UDim2.new(0.947692037, 0, 0.803900123, 0)
                DarknessGradientFrame.Size =
                    UDim2.new(0.00933223031, 0, 0.0797876194, 0)
                ...
                mouse.Move:Connect(function()
                    ...
                    if movingColourSlider then
                        ...
                        local xOffset = (mouse.X -
                                            colourGradientFrame.AbsolutePosition
                                                .X)

                        xOffset = math.clamp(xOffset, 0,
                                             colourGradientFrame.AbsoluteSize.X)

                        local sliderPosNew =
                            UDim2.new(0, xOffset, colourSlider.Position.Y)
                ...
                function returnColour(percentage, gradientKeyPoints)
                    ...
                    for i = 1, #gradientKeyPoints - 1 do
                        ...
                        if gradientKeyPoints[i].Time <= percentage and
                            gradientKeyPoints[i + 1].Time >= percentage then

                            leftColour = gradientKeyPoints[i]
                            rightColour = gradientKeyPoints[i + 1]

                            lerpPercent =
                                (percentage - leftColour.Time) /
                                    (rightColour.Time - leftColour.Time)

                            colour = leftColour.Value:Lerp(rightColour.Value,
                                                           lerpPercent)
                ...
                function updateColourPreview()
                    ...
                    local colourMaxXPos = colourMinXPos +
                                              colourGradientFrame.AbsoluteSize.X
                    ...
                    local colourXPos = (colourSliderX - colourMinXPos) /
                                           colourXPixelSize

                    local darknessMinXPos =
                        darknessGradientFrame.AbsolutePosition.X
                    local darknessMaxXPos = darknessMinXPos +
                                                darknessGradientFrame.AbsoluteSize
                                                    .X
                    ...
                    local darknessXPos =
                        (darknessSliderX - darknessMinXPos) / darknessXPixelSize
                    ...
                    local colour = returnColour(colourXPos,
                                                colourGradientFrame.ColourGradient
                                                    .Color.Keypoints)
                    ...
                    local resultColour =
                        Color3.fromRGB(colourR, colourG, colourB)
                ...
                colourSlider:GetPropertyChangedSignal("Position"):Connect(
                    updateColourPreview)
                darknessSlider:GetPropertyChangedSignal("Position"):Connect(
                    updateColourPreview)
            end
            ...
            function CreateNotification(Name, Description, Callback)
                ...
                TS:Create(Notification2,
                          ...
                          {Position = UDim2.new(1, -390, 0, 900)}):Play()
                ...
                No.MouseButton1Click:Connect(function()
                    ...
                    TS:Create(Notification2,
                              TweenInfo.new(0.3, Enum.EasingStyle.Linear),
                              {Position = UDim2.new(1.25, -390, 0, 900)}):Play()
                    wait(.5)
